...
## [0.5.0](https://github.com/tarqd/js-core/compare/server-sdk-ai-langchain-v0.4.0...server-sdk-ai-langchain-v0.5.0) (2025-11-25)


### ⚠ BREAKING CHANGES

* Change to ES Modules to improve support of dynamic loading ([#1011](https://github.com/tarqd/js-core/issues/1011))
* Support invoke with structured output in LangChain provider  ([#970](https://github.com/tarqd/js-core/issues/970))

### Features

* Add LangChain Provider for AI SDK ([#941](https://github.com/tarqd/js-core/issues/941)) ([9cbfb87](https://github.com/tarqd/js-core/commit/9cbfb87a73c76cc80b9eac29f7409f156037fce7))
...
* Support invoke with structured output in LangChain provider  ([#970](https://github.com/tarqd/js-core/issues/970)) ([0427908](https://github.com/tarqd/js-core/commit/0427908cdd410d1f7fefd405bf08945b559070f5))
...
* Make unit test less brittle and add CI ([#953](https://github.com/tarqd/js-core/issues/953)) ([a2236a9](https://github.com/tarqd/js-core/commit/a2236a9d455c60901b870dfe4beb8cffcfab986f))
