...
## [0.1.0](https://github.com/tarqd/js-core/compare/server-sdk-ai-vercel-v0.4.0...server-sdk-ai-vercel-v0.1.0) (2025-11-25)


### ⚠ BREAKING CHANGES

* Change to ES Modules to improve support of dynamic loading ([#1011](https://github.com/tarqd/js-core/issues/1011))
* Support invoke with structured output in VercelAI provider ([#981](https://github.com/tarqd/js-core/issues/981))
* VercelProvider now requires type safe parameters for Vercel models

### Features

* Add support for tracking streaming text metics with ([28d3650](https://github.com/tarqd/js-core/commit/28d365026fc37d5b5056754d96a9c0615fff0870))
* Add toVercelAISDK method to support easy model creation ([#972](https://github.com/tarqd/js-core/issues/972)) ([28d3650](https://github.com/tarqd/js-core/commit/28d365026fc37d5b5056754d96a9c0615fff0870))
* Add VercelAI Provider for AI SDK ([#948](https://github.com/tarqd/js-core/issues/948)) ([1db731b](https://github.com/tarqd/js-core/commit/1db731b98ca2b9d641ffe8cb30c3f50b3979b54c))
* Renamed createAIMetrics to getAIMetricsFromResponse ([#977](https://github.com/tarqd/js-core/issues/977)) ([05b4667](https://github.com/tarqd/js-core/commit/05b4667fe6385672f89c84d49302ce40f99e28d5))
* Support invoke with structured output in VercelAI provider ([#981](https://github.com/tarqd/js-core/issues/981)) ([d0cb41d](https://github.com/tarqd/js-core/commit/d0cb41d3a06d6216daac76a516949f0243244417))
...
* Check finishReason for an error when determining model success ([28d3650](https://github.com/tarqd/js-core/commit/28d365026fc37d5b5056754d96a9c0615fff0870))
* Fix metric tracking for v5 responses ([e6c42a8](https://github.com/tarqd/js-core/commit/e6c42a866ceb678b5be7da8e097bff71368d2e05))
* Prefer totalUsage over usage when mapping to LDTokenUsage ([28d3650](https://github.com/tarqd/js-core/commit/28d365026fc37d5b5056754d96a9c0615fff0870))
* Properly convert LD model parameters to Vercel model parameters ([28d3650](https://github.com/tarqd/js-core/commit/28d365026fc37d5b5056754d96a9c0615fff0870))
...
* Support previous v4 of Vercel AI SDK ([#962](https://github.com/tarqd/js-core/issues/962)) ([e6c42a8](https://github.com/tarqd/js-core/commit/e6c42a866ceb678b5be7da8e097bff71368d2e05))
* VercelProvider now requires type safe parameters for Vercel models ([28d3650](https://github.com/tarqd/js-core/commit/28d365026fc37d5b5056754d96a9c0615fff0870))
