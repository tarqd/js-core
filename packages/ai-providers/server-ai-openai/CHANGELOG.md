...
## [0.1.0](https://github.com/tarqd/js-core/compare/server-sdk-ai-openai-v0.4.0...server-sdk-ai-openai-v0.1.0) (2025-11-25)


### ⚠ BREAKING CHANGES

* Change to ES Modules to improve support of dynamic loading ([#1011](https://github.com/tarqd/js-core/issues/1011))
* Support invoke with structured output in OpenAI provider ([#980](https://github.com/tarqd/js-core/issues/980))

### Features

* Add OpenAI Provider for AI SDK ([#947](https://github.com/tarqd/js-core/issues/947)) ([5722911](https://github.com/tarqd/js-core/commit/572291103ea47943c3d365cb49babaf3c722e26b))
...
* Support invoke with structured output in OpenAI provider ([#980](https://github.com/tarqd/js-core/issues/980)) ([515dbdf](https://github.com/tarqd/js-core/commit/515dbdf996de92e87d9accec461c0ac9b7e599cd))
